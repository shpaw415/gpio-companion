...
- OpenCode talks to the gpio-companion AI proxy with a baked `GPIO_AI_KEY` (first-setup). Empty dashboard credits return 402. Do not paste a Cloudflare or OpenCode API key. GitHub PAT is still set via `PUT /v1/config/github`
