/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a7fdf9f1ffdfb26f5698aa1c7e35532)
// Runtime types generated with workerd@1.20260918.1 2026-02-17 nodejs_compat
interface __BaseEnv_Env {
	DYNAMIC_PAGE_KV: KVNamespace;
	MARKETPLACE_MEDIA: R2Bucket;
	MARKETPLACE_DB: D1Database;
	BUN_VERSION: "1.3.13";
	SKIP_DEPENDENCY_INSTALL: "true";
	NODE_ENV: string;
	WRANGLER_PORT: string;
	PORT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "SKIP_DEPENDENCY_INSTALL" | "NODE_ENV" | "WRANGLER_PORT" | "PORT">> {}
}
