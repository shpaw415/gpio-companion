/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9acf1e02553f4de252409db042a3567a)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	GITEA_ROOT_URL: "";
	GITEA: DurableObjectNamespace<import("./src/index").GiteaContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GiteaContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITEA_ROOT_URL">> {}
}
